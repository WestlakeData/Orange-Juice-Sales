...
4.  Based on your analysis what are the specific recommendations you have for the brand manager?Pros:
...
```
Boosted Trees models do not provide a great deal of transparency into the relationship between predictor variables and the the outcome.  In order to better understand how the important predictor variables are influencing the prediction, we need to 
```{r Brand Loyalty PDP}
