...
The AUC tells us how optimally our model can handle the balance between true and false positives, but we will ultimately need to choose the optimal threshold for our model.
