...
df.pca <- prcomp(df[-1], scale = TRUE)

eigenvectors <- df.pca$rotation #Eigenvectors are contained in the $rotation 
eigenvectors.PC1_PC4 <- eigenvectors[,1:4] #First 4 Principal Components
...
df_pca <- cbind(df[1],pca_oj) # Rebuild data set after eigenvalue transformation
