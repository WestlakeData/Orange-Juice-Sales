...
**Principle Component Analysis (PCA):** PCA is a mathematical method to combine the portions of correlated independent variables into principle component vectors that allow for the elimination of multicollinearity between original independent variables. In this report the *prcomp()* function from the {stats} package was used to complete PCA.
...
acc_1 <- sum(test$accurate)/nrow(test)

print (paste("Accuracy:",round(acc_1,3)))
