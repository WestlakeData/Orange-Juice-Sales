...
```{r logreg - preproc2, warning=FALSE, echo=TRUE, fig.cap= "Correlogram of Independent Variables"}
...
```{r Lasso logistic regression, warning=FALSE, echo=TRUE, fig.cap='Optimal Lambda in terms of AUC'}
...
```{r Lasso logistic regression 2, warning=FALSE, echo=TRUE, fig.cap='ROC-AUC Curve for Logistic Regression Model'}
...
```{r Accuracy and optimal classification threshold, echo=TRUE, warning=FALSE, fig.cap='Optimal Classification Threshold'}
...
```{r variable importance, warning=FALSE, echo=TRUE, fig.cap='Relative Variable Importance'}
...
```{r Brand Loyalty PDP, echo=TRUE, warning=FALSE, fig.cap='Partial Dependence Profile'}
...
```{r LoyaltyCH vs PriceDiff plot, echo=TRUE, warning=FALSE, fig.cap='Distribution of Outcome Variable for LoyalCH'}
